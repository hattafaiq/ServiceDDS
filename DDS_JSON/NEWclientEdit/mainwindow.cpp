...
void MainWindow::tampil()
{
    ...
    curve3->detach();
    curve4->detach();
    curve1->setRawSamples(x1,y_preprosesing_data1,2560);
    curve2->setRawSamples(x2,y_preprosesing_data2,2560);
    curve3->setRawSamples(x3,y_preprosesing_data3,2560);
    curve4->setRawSamples(x4,y_preprosesing_data4,2560);
    curve1->attach( &plot1 );
    curve2->attach( &plot2 );
    curve3->attach( &plot3 );
    curve4->attach( &plot4 );
...
//    qDebug() << "size data 1: " << sizeof(y_preprosesing_data1)<< "jumlah paket: " << sizeof(y_preprosesing_data1)/sizeof(y_preprosesing_data1[0]);
//    qDebug() << "size data 2: " << sizeof(y_preprosesing_data2)<< "jumlah paket: " << sizeof(y_preprosesing_data2)/sizeof(y_preprosesing_data2[0]);
//    qDebug() << "size data 3: " << sizeof(y_preprosesing_data3)<< "jumlah paket: " << sizeof(y_preprosesing_data3)/sizeof(y_preprosesing_data3[0]);
//    qDebug() << "size data 4: " << sizeof(y_preprosesing_data4)<< "jumlah paket: " << sizeof(y_preprosesing_data4)/sizeof(y_preprosesing_data4[0]);
